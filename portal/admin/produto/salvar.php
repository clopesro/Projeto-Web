<?php require('../../conexao.php');
	...
	if (isset($_POST['codigo_produto'])) {
		...
		$update_produto = "UPDATE produto SET descricao = '$descricao', estoque_inicial = '$estoque_inicial', estoque_atual = '$estoque_atual', fornecedor = '$fornecedor', preco_compra = '$preco_compra', preco_venda = '$preco_venda' WHERE codigo_produto = $codigo_produto";
