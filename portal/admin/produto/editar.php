			...
			<div><h1>ATUALIZAR PRODUTO</h1></div>
				...
				<div class="agrupamento_produto">
						...
						<div>
							...
							<div><input type="text" id="descricao" name="descricao" value="<?php echo $dados_produto['codigo_produto'];?>" required autofocus></div>
						...
						<div>
							...
							<div><input type="text" id="estoque_inicial" name="estoque_inicial" value="<?php echo $dados_produto['codigo_produto'];?>" required autofocus></div>
						...
						<div>
							...
							<div><input type="text" id="estoque_atual" name="estoque_atual" value="<?php echo $dados_produto['codigo_produto'];?>" required autofocus></div>
						...
						<div>
							...
							<div><input type="text" id="fornecedor" name="fornecedor" value="<?php echo $dados_produto['codigo_produto'];?>" required autofocus></div>
						...
						<div>
							...
							<div><input type="text" id="preço_compra" name="preço_compra" value="<?php echo $dados_produto['codigo_produto'];?>" required autofocus></div>
						...
						<div>
							...
							<div><input type="text" id="preço_venda" name="preço_venda" value="<?php echo $dados_produto['codigo_produto'];?>" required autofocus></div>
