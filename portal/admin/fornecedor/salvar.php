<?php require('../../conexao.php');
	...
	if (isset($_POST['codigo_fornecedor'])) {
		...
		$update_fornecedor = "UPDATE fornecedor SET cnpj = '".$cnpj."' WHERE codigo_fornecedor = $codigo_fornecedor";

		$update_fornecedor = "UPDATE fornecedor SET telefone = '".$telefone."' WHERE codigo_fornecedor = $codigo_fornecedor";
	

		$update_fornecedor = "UPDATE fornecedor SET endereco = '".$endereco."' WHERE codigo_fornecedor = $codigo_fornecedor";
	

		$update_fornecedor = "UPDATE fornecedor SET email = '".$email."' WHERE codigo_fornecedor = $codigo_fornecedor";
