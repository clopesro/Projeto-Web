			...
			<div><h1>FORNECEDORES CADASTRADOS</h1></div>
				...
				<?php do{
					...
					<tr>
						...
						<td><?php echo $dados_fornecedor['cnpj'];?></td>
						<td><?php echo $dados_fornecedor['telefone'];?></td>
						<td><?php echo $dados_fornecedor['endereco'];?></td>
						<td><?php echo $dados_fornecedor['email'];?></td>
						<td>
