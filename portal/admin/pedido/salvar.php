<?php require('../../conexao.php');
	...
	if (isset($_POST['codigo_pedido'])) {
		...
		$update_pedido = "UPDATE pedido SET data_compra = '".$data_compra."' WHERE codigo_pedido = $codigo_pedido";
		...
		$insert_pedido = "INSERT INTO pedido (descricao, data_compra) VALUES ('".$descricao."', '".$data_compra."')";
