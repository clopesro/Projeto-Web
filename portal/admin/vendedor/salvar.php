<?php require('../../conexao.php');
	...
	if (isset($_POST['codigo_vendedor'])) {
		...
		$update_vendedor = "UPDATE vendedor SET nome = '".$nome."' WHERE codigo_vendedor = $codigo_vendedor";
		$update_vendedor = "UPDATE vendedor SET cpf = '".$cpf."' WHERE codigo_vendedor = $codigo_vendedor";
