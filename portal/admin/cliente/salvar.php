<?php require('../../conexao.php');
	...
	if (isset($_POST['codigo_cliente'])) {
		...
		$update_cliente = "UPDATE cliente SET nome = '".$nome."' WHERE codigo_cliente = $codigo_cliente";

		$update_cliente = "UPDATE cliente SET cpf = '".$cpf."' WHERE codigo_cliente = $codigo_cliente";
